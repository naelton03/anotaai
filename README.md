...
MVP Flutter para gerenciamento de campeonatos esportivos com persistência local em SQLite, interface responsiva para mobile/tablet e pipeline para geração de APK de teste.
...
- navegação responsiva com `NavigationRail` em telas largas e `NavigationBar` em telas compactas.
